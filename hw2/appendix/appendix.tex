...
\begin{figure}[!htbp]
    \centering
    \includegraphics[height=10cm]{WebBenchExample.png}
    \caption{Image showing the source code folder after running make command}
\end{figure}
...
\noindent
Below are few of the functionalities provided by webbench:
\begin{center}
    \begin{tabular}{ |r|r|m{13cm}|} 
     ...
     \hline
     3 & webbench -p URL &cell9\\ 
     \hline
     4 & webbench -c URL  &cell9\\
     \hline 
     5 & webbench -9 URL &cell9\\ 
     \hline
     6 & webbench -1 URL &cell9\\
     \hline 
     7 & webbench -1 URL &cell9\\ 
     \hline
\end{tabular}
\end{center}
