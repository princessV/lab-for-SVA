...
\subsection{Implementing a stack smashing exploit that uses arc-injection}
When the system enables DEP (Data Execution Prevent), the stack is \"no-executable"
