...
\begin{IEEEkeywords}
 bufferoverflow, Vulnerability, WebBench, Stress Testing
\end{IEEEkeywords}
...
In our case, we turned on ASLR after we successfully implement the code injection. When we want to replay what we do previously, we find that we cannot figure out the address where we want to insert our shellcode.
