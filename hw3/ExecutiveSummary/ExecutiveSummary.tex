...
Secondly, we implment an information leak exploit and arbitrary read. This part is detailed described on our Gitlab project's wiki. ... We watched a video in \textit{youtube} to get to know the process of format string. \cite{v_format_string} ...
